...
type $env:USERPROFILE\.ssh\id_ed25519.pub | ssh saenggibu-nas-local "HOME_DIR=/var/services/homes/ohola; mkdir -p $HOME_DIR/.ssh; cat >> $HOME_DIR/.ssh/authorized_keys; chmod 700 $HOME_DIR/.ssh; chmod 600 $HOME_DIR/.ssh/authorized_keys"
```
